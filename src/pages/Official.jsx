            ...
            <div className="min-h-dvh">
                ...
                <div className="overflow-hidden whitespace-nowrap flex gap-10">
                    <div className="py-6 shrink-0 animate-[scroll-x_10s_linear_infinite_running_alternate] md:animate-[scroll-x_15s_linear_infinite_running_alternate] hover:animate-[scroll-x_15s_linear_infinite_paused_alternate] flex gap-10 before:bg-amber-400">
                        <a href="https://www.instagram.com/p/DHv1aC-B3HV/?igsh=ajFuajF5NG1ubmJo" target="_blank"><img src="https://storage.googleapis.com/campusconnect-iomp.firebasestorage.app/Website%20Images/Poster.png" alt="" className="cursor-pointer h-60 md:h-70 lg:h-80 place-self-center-safe hover:scale-110 border-2 border-white" /></a>
                        <a href="https://www.instagram.com/p/DHv1aC-B3HV/?igsh=ajFuajF5NG1ubmJo" target="_blank"><img src="https://storage.googleapis.com/campusconnect-iomp.firebasestorage.app/Website%20Images/Poster.png" alt="" className="cursor-pointer h-60 md:h-70 lg:h-80 place-self-center-safe hover:scale-110 border-2 border-white" /></a>
                        <a href="https://www.instagram.com/p/DHv1aC-B3HV/?igsh=ajFuajF5NG1ubmJo" target="_blank"><img src="https://storage.googleapis.com/campusconnect-iomp.firebasestorage.app/Website%20Images/Poster.png" alt="" className="cursor-pointer h-60 md:h-70 lg:h-80 place-self-center-safe hover:scale-110 border-2 border-white" /></a>
                        <a href="https://www.instagram.com/p/DHv1aC-B3HV/?igsh=ajFuajF5NG1ubmJo" target="_blank"><img src="https://storage.googleapis.com/campusconnect-iomp.firebasestorage.app/Website%20Images/Poster.png" alt="" className="cursor-pointer h-60 md:h-70 lg:h-80 place-self-center-safe hover:scale-110 border-2 border-white" /></a>
                    </div>
